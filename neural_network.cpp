...
constexpr char const* TRAIN_IMAGES = "C:/Users/Nikola/Documents/MasterWork/train-images.idx3-ubyte";
constexpr char const* TRAIN_LABELS = "C:/Users/Nikola/Documents/MasterWork/train-labels.idx1-ubyte";

constexpr int TEST_COUNT = 10000;
constexpr char const* TEST_IMAGES = "C:/Users/Nikola/Documents/MasterWork/t10k-images.idx3-ubyte";
constexpr char const* TEST_LABELS = "C:/Users/Nikola/Documents/MasterWork/t10k-labels.idx1-ubyte";
...
int main(int argc, char* argv[])
{
	...
	{ // test
		...
		int** confusion_matrix = new int*[10];
		for (int i = 0; i < 10; i++) {
			confusion_matrix[i] = new int[10];
		}
		...
		long long total_test_time = run_and_time([&] {
			for (std::size_t i = 0; i < TEST_COUNT; ++i) {
				...
				confusion_matrix[label][expected_label]++;
			}
		});
		...
		for (int i = 0; i < 10; i++) {
			for (int j = 0; j < 10; j++) {
				std::cout << confusion_matrix[i][j]<<((j==9) ? "\n":" ");
			}
		}
		for (int i = 0; i < 10; ++i)
